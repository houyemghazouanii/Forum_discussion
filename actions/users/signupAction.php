...
//Validation du formulaire _ isset pour verifier que le variable existe
if(isset($_POST['validate'])){

    //Vérifier si l'user a bien complété tous les champs par (empty)
    if(!empty($_POST['pseudo']) AND !empty($_POST['lastname']) AND !empty($_POST['firstname']) AND !empty($_POST['password'])){
        
        //prend Les données de l'user_ eviter qlq faute avec html
